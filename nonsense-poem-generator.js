...
/**
 * Nonsense Poem Generator - JavaScript Edition
...
function generatePoems(count) {
    console.log('='.repeat(60));
    console.log('  🎭 NONSENSE POEM GENERATOR (JavaScript) 🎭');
    console.log('='.repeat(60));
    console.log();
...
if (require.main === module) {
    ...
    if (isNaN(count) || count < 1) {
        console.error('Usage: node nonsense-poem-generator.js [number_of_poems]');
        console.error('Example: node nonsense-poem-generator.js 5');
        process.exit(1);
    }
...
module.exports = { generatePoem, generatePoems };
